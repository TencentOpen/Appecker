...
#ifdef WLENABLELOGGER
#define ATLogDebug(message) NSLog(@"%@",message);
#define ATLogDebugFormat(format,...) NSLog(@"%@", [NSString stringWithFormat:format, ##__VA_ARGS__]);
#else
#define ATLogDebug(message)
#define ATLogDebugFormat(format,...)
#endif
