...
@interface ATViewQuery : NSObject {

}

+(UIView *)findFirstViewInTree:(UIView *)parentView byCondition:(ATCondition *)condition;
+(NSArray *)findAllViewsInTree:(UIView *)parentView byCondition:(ATCondition *)condition;

@end

@interface ATViewQuery (ATViewQueryHelper)
