...
@interface ATTestCase : NSObject {
    Class testClass;
    SEL method;
    NSString *testCaseID;
    NSString *testCaseName;
    NSString *testCaseAuthor;
    NSString *testCaseDescription;
}

@property (nonatomic, assign) Class testClass;
@property (nonatomic, assign) SEL method;
@property (nonatomic, retain) NSString *testCaseID;
@property (nonatomic, retain) NSString *testCaseName;
@property (nonatomic, retain) NSString *testCaseAuthor;
@property (nonatomic, retain) NSString *testCaseDescription;
