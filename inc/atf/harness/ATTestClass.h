...
@interface ATTestClass : NSObject {
    Class _testClass;
    NSString *_testClassDescription;
    NSMutableDictionary *_testCases;
}

@property (nonatomic, assign) Class testClass;
@property (nonatomic, retain) NSString *testClassDescription;
@property (nonatomic, retain, readonly) NSDictionary *testCases;
